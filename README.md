...
El proyecto está construido bajo una arquitectura web limpia y escalable:

- **HTML5 Semántico**: Estructuración clara de las diversas secciones (Carruseles, Red de Estudios, Proyectos, Habilidades).
- **CSS3 Premium (Dark Theme)**: Implementación de diseño "Hegemónico" en tendencia para Startups usando *Glassmorphism* (Cristal ahumado), hover effects dinámicos (*Spotlights*) y cursores personalizados.
- **JavaScript (Vanilla)**: Control de la lógica para el filtro de categorías en los proyectos, resaltados en barra de navegación y seguimiento avanzado del mouse.
...
├── 📁 css
│   └── 📄 style.css   # Variables CSS y estilos de diseño avanzado
└── 📁 js
    └── 📄 main.js     # Script de inicialización, filtros e interacciones de sistema
```
